...
var MathBackendWebGL = (function () {
    ...
    MathBackendWebGL.prototype.fromPixels = function (pixels, numChannels) {
        ...
        var pixelsInstance = pixels ? pixels.constructor.name : 'undefined';
        ...
        if (pixelsInstance === 'HTMLVideoElement') {
            if (this.fromPixels2DContext == null) {
                ...
                this.fromPixels2DContext =
                    canvas_util_1.createCanvas().getContext('2d');
            }
    ...
    MathBackendWebGL.prototype.shallowSlice = function (x, begin, size) {
        ...
        var t = tensor_1.Tensor.make(size, {}, x.dtype);
    ...
    MathBackendWebGL.prototype.realDivide = function (a, b) {
        ...
        if (environment_1.ENV.get('WEBGL_PACK_BINARY_OPERATIONS')) {
            return this.packedBinaryOp(a, b, binaryop_packed_gpu_1.PACKED_DIV, outputDtype);
        }
    ...
    MathBackendWebGL.prototype.floorDiv = function (a, b) {
        ...
        if (environment_1.ENV.get('WEBGL_PACK_BINARY_OPERATIONS')) {
            return this.packedBinaryOp(a, b, binaryop_packed_gpu_1.PACKED_INT_DIV, outputDtype);
        }
        var program = new binaryop_gpu_1.BinaryOpProgram(op, a.shape, b.shape);
        var output = this.makeOutputArray(program.outputShape, outputDtype);
        return this.compileAndRun(program, [a, b], output);
    ...
    MathBackendWebGL.prototype.pow = function (a, b) {
        ...
        var program = usePackedOp ?
            new binaryop_packed_gpu_1.BinaryOpPackedProgram(binaryop_packed_gpu_1.PACKED_POW, a.shape, b.shape) :
    ...
    MathBackendWebGL.prototype.prelu = function (x, alpha) {
        var program = new binaryop_gpu_1.BinaryOpProgram(binaryop_gpu.PRELU, x.shape, alpha.shape);
